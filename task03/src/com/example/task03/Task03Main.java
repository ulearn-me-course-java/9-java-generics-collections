...
public class Task03Main {
    ...
    public static List<Set<String>> findAnagrams(InputStream inputStream, Charset charset)   {
        ...
        Map<Integer, Set<String>> groupingWords = getGroupingWords(inputStream, charset);
    ...
    public static Map<Integer, Set<String>> getGroupingWords(InputStream inputStream, Charset charset) {
        //кол-во букв, слова
